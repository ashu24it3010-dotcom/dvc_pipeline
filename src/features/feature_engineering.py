...
def apply_tfidf(train_data: pd.DataFrame, test_data: pd.DataFrame, max_features: int) -> tuple:
    ...
    try:
        vectorizer = DictVectorizer(max_features=max_features)
...
def main():
    try:
        ...
        save_data(train_df, os.path.join("./data", "processed", "train_dict.csv"))
        save_data(test_df, os.path.join("./data", "processed", "test_dict.csv"))
    except Exception as e:
